...
void CUSBInterface::LoadDLL()
{
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_CreateFile");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_CloseHandle");
		return;
	}
	...
	if (m_pReadFile == NULL)
	{
		AfxMessageBox("Error: Can't Find FT_W32_ReadFile");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_WriteFile");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_GetOverlappedResult");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_GetCommState");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_GetCommTimeouts");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_PurgeComm");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_SetCommMask");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_SetComMState");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_SetCommTimeouts");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_SetupComm");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_ClearCommError");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_EscapeCommFunction");
		return;
	}
	...
	{
		AfxMessageBox("Error: Can't Find FT_W32_GetLastError");
		return;
	}
}
